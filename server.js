...
// MongoDB Connection
const MONGO_URI = process.env.MONGO_URI || 'const MONGO_URI = process.env.MONGO_URI || 'mongodb+srv://vybeadmin:YourPasswordHere@cluster0.xxxxx.mongodb.net/vybe?retryWrites=true&w=majority';
